...
- have *1 pair of antennae* (触角)
#### Arachnids  (蛛形纲)
- 4 pairs of legs
- **2 part** segmented body - head and thorax(头, 胸)
...
- **3 part segmented** body divided into head, thorax and abdomen (头，胸，腹)
- some insects can live in very dry places


| Features     | Crustacean | Myriapods       | Arachnids                 | Insects               |
| ------------ | ---------- | --------------- | ------------------------- | --------------------- |
| Antennae     | 2 pairs    | 1 pair          | no                        | 1 pair                |
| part of body | /          | multiple        | head, throax              | head, thorax, abdomen |
| legs         | >=4 pairs  | on each segment | 4 pairs                   | 3 pairs               |
| spec         | aquatic    | flexible body   | more than one set of eyes | 2 pairs of wings      |
